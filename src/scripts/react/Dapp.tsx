    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setState({
        ...
        <>
          ...
          <br />
          However, you can always interact with the smart-contract through <a href={defaultState.etherscanUrl} target="_blank">Etherscan</a>. Ask us on Discord if you're having trouble!<br />
        </>,
      });
    }
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-etherscan">
              Hey, looking for an <strong>alternative experience if this website is down</strong>? <span className="emoji">🐱</span><br />
              You can interact with the smart-contract <strong>directly</strong> through <a href={this.state.etherscanUrl} target="_blank">Etherscan</a>, without connecting your wallet to this DAPP.<br />
            </div>
